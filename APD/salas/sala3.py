...
def salaa3(color_fondo):
    ...
    texto_pregunta = fuente_pregunta.render("Que funcion tiene un archivo", True, color_fondo)
    texto2_pregunta = fuente_pregunta.render("'__init__'?", True, color_fondo)
    ...
    texto_opcion1 = fuente_opciones.render("Sirve para ejecutar el codigo principal de la", True, color_fondo)
    texto2_opcion1 = fuente_opciones.render("aplicacion", True, color_fondo)
    rect_opcion1 = pygame.Rect(100, 270, 600, 80)
    texto_opcion2 = fuente_opciones.render("Es un archivo temporal que se elimina al compilar", True, color_fondo)
    ...
    while flag_juego:
        ...
        pantalla.blit(texto2_pregunta, (290, 155))
        ...
        pantalla.blit(texto_opcion2, (130, 400))
