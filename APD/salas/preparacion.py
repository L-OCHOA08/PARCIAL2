...
def ingreso_individual(color_fondo, cant_jugadores, lista_jugadores):
    for i in range(cant_jugadores):
        ...
        ingreso_font = pygame.font.Font("Golden Age Shad.ttf", 30)
        ingreso_font_titulo = pygame.font.Font("Golden Age.ttf", 40)
        ingreso = ""

        # BOTON DE JUGAR
        jugar_rect = pygame.Rect(275, 300, 250, 80)
        jugar_font = pygame.font.Font("Golden Age Shad.ttf", 40)
...
# ingreso_individual((161, 147, 250), 1, ['lean'])