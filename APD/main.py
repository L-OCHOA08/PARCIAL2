...
flecha_abajo = pygame.image.load("flecha_abajo.svg")
...
fuente_jugar = pygame.font.Font("Golden Age Shad.ttf", 40)
        ...
        if evento.type == pygame.MOUSEBUTTONDOWN:
            ...
            if evento.button == 1:
                if marco_jugar.collidepoint(evento.pos):
                    ingreso_individual(COLOR_FONDO,contador, lista_jugadores)
